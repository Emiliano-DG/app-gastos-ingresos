...
export const ListaPaises = ({ setSelect, setState }) => {
  ...
  return (
    <div className="mt-10 absolute top-[32%] w-full flex flex-col bg-bgtotal rounded-[10px] border-[3px] border-[#3a3a3a] p-2.5 gap-2.5 text-text transition duration-300 md:w-[400px]">
